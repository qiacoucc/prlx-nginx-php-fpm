...
# Atatus
RUN wget https://s3.amazonaws.com/atatus-artifacts/atatus-php/downloads/atatus-php-1.6.1-x64-musl.tar.gz && tar -xzvf atatus-php-1.6.1-x64-musl.tar.gz && cd atatus-php-1.6.1-x64-musl && ./install.sh
